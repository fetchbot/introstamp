...
enum SegmentValidator {
    ...
    static func makeSubmissionRequest(from draft: SubmissionDraft) throws -> IntroDBSubmissionRequest {
        ...
        return try validatedRequest(from: draft)
    }

    private static func validatedRequest(from draft: SubmissionDraft) throws -> IntroDBSubmissionRequest {
    ...
    private static func validateIntroOrRecap(draft: SubmissionDraft, maxDurationMs: Int) throws -> IntroDBSubmissionRequest {
    ...
    private static func validateCreditsOrPreview(draft: SubmissionDraft, maxDurationMs: Int) throws -> IntroDBSubmissionRequest {
